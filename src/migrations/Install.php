...
class Install extends Migration
{
   ...
   /**
    ...
    protected function createTables()
    {
        ...
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%craftcmscontests_craftcmscontestsrecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%craftcmscontests_craftcmscontestsrecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    {
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%craftcmscontests_craftcmscontestsrecord}}', 'siteId'),
            '{{%craftcmscontests_craftcmscontestsrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
        $this->dropTableIfExists('{{%craftcmscontests_craftcmscontestsrecord}}');
    }
}
