...
class CraftcmsContestsUtilityUtilityAsset extends AssetBundle
{
    ...
    {
        $this->sourcePath =
            "@therefinery/craftcmscontests/assetbundles/craftcmscontestsutilityutility/dist";

        $this->depends = [CpAsset::class];

        $this->js = ["js/CraftcmsContestsUtility.js"];

        $this->css = ["css/CraftcmsContestsUtility.css"];
